...
--
ALTER TABLE `cmdqueue`
  MODIFY `cmdid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=499;
--
...
--
ALTER TABLE `raw`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8207018;
--
-- AUTO_INCREMENT für Tabelle `statuslog`
--
ALTER TABLE `statuslog`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=571833;
